...
import os
class OracleQueries: # Class que realizar conexão com banco

    def __init__(self, can_write:bool=False): # Construtor 
    ...
    def write(self, query:str):
        if not self.can_write: # retorna se conexão não tiver nada na query
